    ...
    <main className="min-h-screen max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="prose max-w-none">
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">Join Our Team of Professional Boosters</h2>
        ...
        <section className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div className="border rounded-lg p-6">
              <h3 className="text-xl font-semibold mb-2">Professional Environment</h3>
              <p className="text-gray-700">
                Work with a professional team and management system that respects your time.
              </p>
            </div>
            <div className="border rounded-lg p-6">
              <h3 className="text-xl font-semibold mb-2">Regular Payouts</h3>
              <p className="text-gray-700">
