      ...
      <section className="max-w-7xl mx-auto px-4 py-12 md:py-16">
        <div className="text-center space-y-4">
          ...
          <div className="pt-2">
            <Link
              href="/games"
              className="inline-flex items-center gap-2 px-6 py-3 gradient-purple text-white font-semibold rounded-lg hover:opacity-90 transition-all transform hover:scale-105"
            >
              Browse Services
