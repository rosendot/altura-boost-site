...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen bg-black">
      {/* Hero Section */}
      <section aria-labelledby="hero-heading" className="max-w-7xl mx-auto p-4">
        <div className="text-center space-y-4">
          ...
          <Link
            href="/games"
            className="inline-flex items-center p-2 gradient-purple text-white font-semibold rounded-lg hover:opacity-90 transition-all transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-primary-500"
          >
            Browse Services
          </Link>
        </div>
      ...
      {/* Trust Badges */}
      <section aria-label="Trust and quality features" className="max-w-7xl mx-auto">
        <ul className="grid grid-cols-1 md:grid-cols-3 gap-2">
          <li className="bg-gray-900/50 border border-gray-800 rounded-xl p-4 hover:border-primary-700 transition-colors">
      ...
      {/* Featured Game Cards */}
      <section aria-label="Available games" className="max-w-7xl mx-auto p-2">
