export default function TermsOfService() {
  return (
    <main className="min-h-screen max-w-4xl mx-auto px-4 py-8">
      ...
      <p className="text-gray-600 mb-8">Last updated: December 6, 2024</p>
      ...
      <div className="prose max-w-none space-y-8">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">6. Booster Terms</h2>
          <p className="text-gray-700 mb-4">If you are working as a booster, you agree to:</p>
          <ul className="list-disc list-inside space-y-2 text-gray-700">
