        ...
        <div className="mt-8 pt-6 border-t border-primary-900/20">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-4">
              <Link href="#" className="text-gray-400 hover:text-primary-400 transition-colors shadow-md hover:shadow-primary-600/30" aria-label="Follow us on Twitter">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z" />
                </svg>
              </Link>
              <Link href="#" className="text-gray-400 hover:text-primary-400 transition-colors shadow-md hover:shadow-primary-600/30" aria-label="Join our Discord server">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
